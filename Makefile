SRCS :=		ft_isalpha.c ft_memcmp.c  ft_putendl_fd.c ft_strdup.c ft_strlen.c ft_strtrim.c\
			...
			ft_isalnum.c ft_itoa.c ft_memchr.c  ft_putchar_fd.c ft_strchr.c  ft_strlcpy.c ft_strrchr.c ft_isalpha.c
